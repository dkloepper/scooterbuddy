...
st.markdown('''This app was developed as a final course project for MABA6490, fall semester 2022 at Carlson School of Management, University of Minnesota.
        Full disclosure: I have never rented a foot scooter or even taken a ride on one.
...
with about_mapping:
    ...
    st.markdown("More information <a href='https://randyzwitch-streamlit-folium-examplesstreamlit-app-qc22uj.streamlit.app/')HERE</a>",unsafe_allow_html=True)
    st.markdown("""streamlit_folium enables easy application of Folium within a streamlit app. Thank you to Randy Zwitch.""")
    st.markdown("More information can be found <a href='https://randyzwitch-streamlit-folium-examplesstreamlit-app-qc22uj.streamlit.app/')HERE</a> on another Streamlit app.",unsafe_allow_html=True)
